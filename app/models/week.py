...
class Week(db.Model, BaseModel):
    ...
    category = db.relationship('Category', uselist=False, backref="week")
    school_class = db.relationship('SchoolClass', uselist=False, backref="week")
